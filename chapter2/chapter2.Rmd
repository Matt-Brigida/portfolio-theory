...
This allows us to plot our possible $E(r_c)$ and $\sigma_c$ combinations (our investment opportunity set).  
...
renderPlot({
  ...
  plot(oppSet, type = 'l', xlab = "Complete Portfolio Standard Deviaion", ylab = "Complete Portfolio Expected Return", lwd = 4, col = 3, main = "Investment Opportunity Set")
  ## legend("topleft", legend = paste("Utility = ",input$utility, sep = ""), col = 3, lty = 1, lwd = 4)
})
```
