...
Skewness is a measure of asymmetry in the distribution.  Positively skewed assets have long tails in the direction of positive returns, and the opposite for negatively skewed assets. As mentioned earlier, symmetric measures of risk such as the standard deviation are less relevant if the distribution is very skewed on either direction.

There is ample evidence that asset return distributions are skewed, particularly for individual assets as opposed portfolios.  Some of this evidence points to risk-takers actively seeking out and buying positively skewed stocks. 
